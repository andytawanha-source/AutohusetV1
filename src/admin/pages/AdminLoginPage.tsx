    ...
    <div className="flex min-h-screen items-center justify-center bg-brand-primary p-4">
      ...
      <form onSubmit={submit} className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
        ...
        <button
          type="submit"
          disabled={loading}
          className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-brand-primary px-4 py-3 font-semibold text-white hover:opacity-90 disabled:opacity-60"
        >
