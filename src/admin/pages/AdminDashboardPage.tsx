...
import { Car, CheckCircle2, Clock, FileEdit, MessageSquare, Tag } from "lucide-react";
...
export default function AdminDashboardPage() {
  ...
  const byStatus = (status: string) => vehicles.filter((v) => v.status === status).length;
  ...
  return (
    <div className="space-y-8">
      ...
      <section aria-label="Nøgletal" className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <StatCard label="Aktive biler" value={byStatus("published")} icon={Car} to="/admin/biler" />
